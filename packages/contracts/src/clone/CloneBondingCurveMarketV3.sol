...
contract CloneBondingCurveMarketV3 {
    uint256 private constant BPS_DENOMINATOR = 10_000;

    uint64 public constant FAIR_START_DELAY_BLOCKS = 1;
    uint64 public constant FAIR_START_DURATION_BLOCKS = 10;
    uint16 public constant FAIR_START_MAX_TX_BPS = 100;
    uint16 public constant FAIR_START_MAX_WALLET_BPS = 300;
