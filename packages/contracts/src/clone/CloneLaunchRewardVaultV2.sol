...
/// @notice Immutable launch-fee accounting with permissionless settlement to fixed recipients.
contract CloneLaunchRewardVaultV2 {
    ...
    /// @notice Anyone may trigger payment, but ETH can only go to the recorded recipient.
