...
TEST_CONTROLLER="0x2000000000000000000000000000000000000001"
...
for (const name of ["LowCostMemeLaunchFactoryV4", "ProtocolRevenueRouter", "VersionedFactoryRegistry"]) {
