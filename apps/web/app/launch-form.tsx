...
export function LaunchForm() {
  ...
  return (
    <section className="panel launchConfigPanel">
      ...
      {deployed && <div className="launchSuccess"><strong>Launch #{deployed.launchId.toString()} confirmed</strong><span>Token, market, and fee splitter were created in one transaction.</span><Link href={`/token/${deployed.token}?launch=${deployed.launchId.toString()}`}>Open token page →</Link></div>}
