    ...
    <main className="directoryPage personalPage">
      <header className="directoryHero">
        <div>
          ...
          <p>Keep interesting RMT launches close. Signed-in profiles sync privately across devices, with this browser as the fallback.</p>
        </div>
      ...
      <div className="personalPageHint panel">
        ...
        <span>Tap Watchlist on a verified RMT token. RMT never makes your saved list public.</span>
      </div>
      <WatchlistPanel />
      <SiteFooter />
    </main>
