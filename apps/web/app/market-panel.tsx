  ...
  return (
    <section className="panel marketPanel">
      ...
      {mode === "buy" ? <div className="tradeAmountCard">
        ...
        {needsApproval && <p className="approvalNote">Your first sell creates a reusable allowance for this token’s immutable market. You can revoke it from your wallet at any time.</p>}
      </div>}
