...
export async function verifyZeroXSwapFirmQuote(request: VNextProviderVerificationRequest, observe?: ZeroXFirmObserver): Promise<ZeroXSwapFirmQuoteVerificationEvidence> {
