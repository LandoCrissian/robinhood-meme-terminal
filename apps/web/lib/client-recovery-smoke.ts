...
const legacyHome = readFileSync(new URL("../app/legacy-terminal-page.tsx", import.meta.url), "utf8");
...
assert.match(legacyHome, /RecoveryBoundary name="market-feed" fallback=\{<MarketFeedRecovery \/>\}/);
