...
export const launchSchema = z.object({
  name: z.string().trim().min(2, "Name must be at least 2 characters").max(32).regex(/^[A-Za-z0-9 .'_\-]+$/, "Use letters, numbers, spaces, apostrophes, periods, hyphens, or underscores"),
