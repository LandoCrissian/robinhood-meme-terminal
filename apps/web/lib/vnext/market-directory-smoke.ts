...
assert.doesNotMatch(ecosystemRoute, /fetchGeckoPoolSnapshot/, "Curated browse enrichment must not fan out through chain-wide Gecko discovery");
...
assert.match(geckoFeed, /duration: "5m"/);
assert.match(geckoFeed, /duration: "1h"/);
assert.match(geckoFeed, /duration: "24h"/);
