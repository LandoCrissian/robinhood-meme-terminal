...
assert.match(marketDirectoryRouteServer, /const result = await dependencies\.readCanonical\(requestUrl\)/);
assert.doesNotMatch(marketDirectoryRouteServer, /vNextCanonicalBrowseEnabled|RMT_CANONICAL_BROWSE_ENABLED/);
