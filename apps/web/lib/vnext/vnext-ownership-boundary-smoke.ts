...
const terminalCss = readFileSync(join(vnextAppDirectory, "vnext-terminal.css"), "utf8");
assert.doesNotMatch(terminalCss, /!important/);
assert.match(terminalCss, /Canonical terminal presentation: Markets, Asset, Portfolio, and mobile trade sheet/);
