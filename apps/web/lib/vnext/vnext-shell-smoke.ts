...
assert.match(styles, /\.vnWorkspaceGrid[\s\S]*grid-template-columns: minmax\(0, 1fr\) minmax\(340px, 390px\)/);
assert.match(styles, /\.vnDiscoveryWorkspace[\s\S]*grid-template-columns: minmax\(270px, 0\.72fr\) minmax\(0, 1\.28fr\)/);
