...
assert.match(composer, /failed: \(cause\) =>[\s\S]*setQuoteState\(\{ state: "error", message, phase: failureJourneyPhase[\s\S]*setVerificationState\(\{ state: "error", message \}\)[\s\S]*setAuthorizationState\(\{ state: "error", message \}\)/);
