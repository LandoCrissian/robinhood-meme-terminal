...
CREATE TABLE IF NOT EXISTS nft_marketplace_collection_identity (
 ...
 scope text NOT NULL CHECK(scope IN('EXACT_CONTRACT_SCOPE','MULTI_CONTRACT_COLLECTION_SCOPE')), member_contracts jsonb NOT NULL,
...
CREATE TABLE IF NOT EXISTS nft_marketplace_orders (
 ...
 protocol_data jsonb, evidence_digest text NOT NULL, first_seen_at timestamptz NOT NULL, last_seen_at timestamptz NOT NULL,
...
CREATE TABLE IF NOT EXISTS nft_marketplace_sales (
 ...
 project_id text NOT NULL, collection_address text NOT NULL, token_id numeric(78,0) NOT NULL, quantity numeric(78,0) NOT NULL,
 seller text NOT NULL, buyer text NOT NULL, payment_kind text, payment_address text, payment_symbol text, payment_decimals integer,
 gross_amount numeric(78,0), transaction_hash text, order_hash text, protocol_address text, event_timestamp timestamptz NOT NULL,
