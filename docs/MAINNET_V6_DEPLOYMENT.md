...
The same 70/30 splitter receives curve fees and collected fees from the canonical Uniswap v4 position. Creators receive fees only; they receive no initial token allocation, liquidity ownership, or claim on locked principal.
...
- [Archived RMT V4 deployment](archive/rmt-v4/MAINNET_DEPLOYMENT.md) — retired product-generation evidence
