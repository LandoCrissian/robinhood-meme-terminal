...
- Current owner product policy authorizes exactly 25 basis points on trades atomically executed through the admitted `RMT_EXECUTION_V1` Uniswap V3 fee executor. Every other provider and unsupported V1 route remains direct/no-RMT-fee. Preserve the pinned V1 deployment, proof, receipts, hashes, manifest and release boundaries. `RMT_EXECUTION_V2` remains dormant and authorizes nothing.
